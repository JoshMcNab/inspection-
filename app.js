const CLOUD_ENDPOINT="https://rvkutsfyglopbhrnbotx.supabase.co/functions/v1/workshop-inspections";
...
function newClientId(){try{return crypto.randomUUID()}catch(e){return `inspection-${Date.now()}-${Math.random().toString(36).slice(2)}`}}
